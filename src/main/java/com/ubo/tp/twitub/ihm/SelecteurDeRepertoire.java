...
public class SelecteurDeRepertoire extends JFrame {

    private JButton button;
    private JTextArea textArea;
    private JFileChooser fileChooser;

    public SelecteurDeRepertoire(EntityManager mEntityManager) {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int returnVal = fileChooser.showOpenDialog(SelecteurDeRepertoire.this);
