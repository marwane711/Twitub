...
import main.java.com.ubo.tp.twitub.ihm.SelecteurDeRepertoire;
...
public class Twitub {
	...
	protected SelecteurDeRepertoire mSelecteurDeFichier;
	...
	protected void initSelecteurDeRepertoire() {
		this.mSelecteurDeFichier = new SelecteurDeRepertoire(this.mEntityManager);
	}
